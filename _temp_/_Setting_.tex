...
\newtcolorbox{reidai}[1][]{breakable,enhanced,boxrule=0.5mm,
	...
	boxrule=1pt,
	underlay={
		\node[inner sep=1pt,blue!50!black,fill=blue!10!white]at ([xshift=22pt,yshift=-9pt]interior.north west) {\stepcounter{reidaibangou}\bfseries\gtfamily Ex.\thereidaibangou};},
	segmentation code={%
